# eGAR Nginx Proxy Docker Container
...
[tags on this repository](https://github.com/UKHomeOffice/egar-nginx-proxy/tags). 

## Authors

* **Pawel Niemiec** - *Initial work* - [GitHub](https://github.com/pawniemiec)

See also the list of [contributors](https://github.com/UKHomeOffice/egar-nginx-proxy/contributors) who 
